      ...
      <div className="py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="max-w-md mx-auto">
            ...
            />
            <h3 className="text-xl font-semibold mb-2" style={{ color: '#D4A017' }}>
              Dr. Name of President
            </h3>
            <p className="text-gray-600 mb-4">
              University President
            </p>
            <p className="text-gray-700 text-lg leading-relaxed">
              Dr. [President's Name] has been leading Bulacan State University with vision and dedication, guiding the institution towards greater heights in education, research, and community service.
            </p>
          </div>
        </div>
      </div>
