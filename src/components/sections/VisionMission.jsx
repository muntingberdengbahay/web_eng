...
const VisionMission = () => {
  return (
    <section className="py-16 bg-university-red text-white">
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12">
        <div className="p-8 bg-university-dark rounded-xl">
          <h3 className="text-2xl font-bold mb-4 flex items-center gap-2">
            <span className="text-university-gold text-4xl">"</span> Our Vision
          </h3>
        ...
        <div className="p-8 bg-university-dark rounded-xl">
          <h3 className="text-2xl font-bold mb-4 flex items-center gap-2">
            <span className="text-university-gold text-4xl">"</span> Our Mission
          </h3>
          <p className="text-blue-100 italic">
